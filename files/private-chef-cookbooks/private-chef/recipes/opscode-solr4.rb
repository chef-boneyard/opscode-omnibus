...
node.default['private_chef']['opscode-solr4']['command'] << " -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=18086 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
