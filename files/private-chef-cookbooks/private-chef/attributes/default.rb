...
default['private_chef']['dark_launch']["sql_users"] = false
default['private_chef']['dark_launch']["sql_containers"] = false
default['private_chef']['dark_launch']["sql_groups"] = false
